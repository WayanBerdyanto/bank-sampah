...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item py-2 " href="/banksampah/profilebank">
                                    <i class="fa-solid fa-address-card mr-3"></i>
                                    Profile
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item py-2 " href="/banksampah/ubahpassword">
    ...
    @include('banksampah.layouts.sidebar')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="/banksampah/logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
